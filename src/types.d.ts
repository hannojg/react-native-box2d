...
export declare namespace Box2D.Common {
  /**
...
declare namespace Box2D.Common {
  ...
  export class b2Settings {
     ...
     **/
    public static b2MixRestitution(
      restitution1: number,
      restitution2: number
    ): number;
...
declare namespace Box2D.Collision {
  ...
  export class b2DynamicTree {
    ...
    public MoveProxy(
      ...
      aabb: b2AABB,
      displacement: Box2D.Common.Math.b2Vec2
    ): boolean;
...
declare namespace Box2D.Collision.Shapes {
  ...
  export class b2PolygonShape extends b2Shape {
     ...
     **/
    public static AsEdge(
      v1: Box2D.Common.Math.b2Vec2,
      b2: Box2D.Common.Math.b2Vec2
    ): b2PolygonShape;
...
declare namespace Box2D.Collision.Shapes {
  ...
  export class b2Shape {
    ...
    public static TestOverlap(
      ...
      shape2: b2Shape,
      transform2: Box2D.Common.Math.b2Transform
    ): boolean;
...
declare namespace Box2D.Dynamics {
  ...
  export class b2Body {
     ...
     **/
    public ApplyForce(
      force: Box2D.Common.Math.b2Vec2,
      point: Box2D.Common.Math.b2Vec2
    ): void;
     ...
     **/
    public ApplyImpulse(
      impulse: Box2D.Common.Math.b2Vec2,
      point: Box2D.Common.Math.b2Vec2
    ): void;
    ...
    public GetLinearVelocityFromLocalPoint(
      localPoint: Box2D.Common.Math.b2Vec2
    ): Box2D.Common.Math.b2Vec2;
    ...
    public GetLinearVelocityFromWorldPoint(
      worldPoint: Box2D.Common.Math.b2Vec2
    ): Box2D.Common.Math.b2Vec2;
    ...
    public GetLocalVector(
      worldVector: Box2D.Common.Math.b2Vec2
    ): Box2D.Common.Math.b2Vec2;
    ...
    public GetWorldVector(
      localVector: Box2D.Common.Math.b2Vec2
    ): Box2D.Common.Math.b2Vec2;
...
declare namespace Box2D.Dynamics {
  ...
  export class b2World {
    ...
    public CreateController(
      controller: Controllers.b2Controller
    ...
    public RayCast(
      ...
      point1: Box2D.Common.Math.b2Vec2,
      point2: Box2D.Common.Math.b2Vec2
    ): void;
...
declare namespace Box2D.Dynamics.Joints {
  ...
  export class b2DistanceJointDef extends b2JointDef {
    ...
    public Initialize(
      bA: b2Body,
      bB: b2Body,
      anchorA: Box2D.Common.Math.b2Vec2,
      anchorB: Box2D.Common.Math.b2Vec2
    ): void;
  }
}
...
declare namespace Box2D.Dynamics.Joints {
  ...
  export class b2FrictionJointDef extends b2JointDef {
    ...
    public Initialize(
      bA: b2Body,
      bB: b2Body,
      anchor: Box2D.Common.Math.b2Vec2
    ): void;
  }
}
...
declare namespace Box2D.Dynamics.Joints {
  ...
  export class b2PulleyJointDef extends b2JointDef {
    ...
    public Initialize(
      bA: b2Body,
      bB: b2Body,
      gaA: Box2D.Common.Math.b2Vec2,
      gaB: Box2D.Common.Math.b2Vec2,
      anchorA: Box2D.Common.Math.b2Vec2,
      anchorB: Box2D.Common.Math.b2Vec2
    ): void;
  }
